<template>
  <div class="container" id="container-home">
    <el-container class="container">
      <el-aside
        class="aside"
        style="width:324px;height: 100%;position: fixed;left: 0;"
      >
        <div class="aside-container">
          ...
          <ul class="person-ul">
            <li
              class=" li-selected-background"
              :style="{
                backgroundImage:
                  'url(' + (selected == 1 ? coverImgUrl : baseImg) + ')',
                backgroundSize: 'contain',
              }"
            >
              <p
                class="my-purchase icon"
                style="margin: 0;text-align: left;color: #7f648e;"
                :style="{ color: selected == 1 ? '#7f648e' : '#fff' }"
                @click="selected1"
              >
                预约处理
              </p>
            ...
            <li
              ...
              :style="{
                backgroundImage:
                  'url(' + (selected == 2 ? coverImgUrl : baseImg) + ')',
                backgroundSize: 'contain',
              }"
            >
              <p
                class="my-purchase icon"
                style="margin: 0;text-align: left;color: #7f648e;"
                :style="{ color: selected == 2 ? '#7f648e' : '#fff' }"
                @click="selected2"
              >
                预约列表
              </p>
            ...
            <li
              ...
              :style="{
                backgroundImage:
                  'url(' + (selected == 3 ? coverImgUrl : baseImg) + ')',
                backgroundSize: 'contain',
              }"
            >
              <p
                class="my-purchase icon"
                style="margin: 0;text-align: left;color: #7f648e;"
                :style="{ color: selected == 3 ? '#7f648e' : '#fff' }"
                @click="selected3"
              >
                新闻发布
              </p>
      ...
      <el-container class="main" style="margin-left:324px;">
        ...
        <el-col :span="24" class="main-container">
          ...
          <AppointmentDealUn
            v-if="selected == 1"
            ref="appointmentDealUn"
          ></AppointmentDealUn>
          <!-- 预约列表 -->
          <AppointmentDealCompleted
            v-if="selected == 2"
            ref="appointmentDealCompleted"
          ></AppointmentDealCompleted>
          <!-- 新闻发布 -->
